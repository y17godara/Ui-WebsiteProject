...
const Navbar = () => {
  ...
  useEffect(() => {
    // console.log("Cureent Theme: ", theme);
    if (theme == 'dark') {
      console.log("Mode Activated Dark");
    }
    else {
      console.log("Mode Activated Light");
    }
      ...
      <header className=" w-full shadow-css 1.95px 1.95px 2.6px;]">
        ...
        <nav className="max-w-[1280px] m-auto flex items-center justify-between h-[94px] p-4">
          ...
          <NavLink to={'/'} >
            ...
            <svg className="svgDarkMode" width="186" height="54" viewBox="0 0 186 54" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="logo">
